...
interface EditableProfileSidebarProps {
  profileImage?: string;
  timezone?: string;
  languages?: string[];
  socialLinks?: Array<{
...
export function EditableProfileSidebar({
  profileImage,
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 sticky top-[58px] self-start">
      ...
      {/* Timezone */}
      <div className="content-stretch flex gap-[8px] items-center relative shrink-0 mt-4 w-full">
        ...
        <EditableField
          ...
          isEditing={isEditing}
          className="flex flex-col font-['Geist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[16px] text-nowrap text-text-primary flex-1"
        />
      </div>

      {/* Languages */}
      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 mt-4 w-full">
        {isEditing ? (
          <EditableList
            items={languages}
          ...
          <div className="content-stretch flex flex-wrap gap-[0px_8px] items-start relative shrink-0">
            {languages.map((lang) => (
              <div
                key={lang}
